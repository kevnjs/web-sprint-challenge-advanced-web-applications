...
A token is used for authenticating a user when signing into a website

2. What steps can you take in your web apps to keep your data secure?

You can require authentication on every action made on your webapp, have certain requirements when routing to different pages and limiting viewable components such using tokens and headers

3. Describe how web servers work.

Web servers host website code and receive crud actions from clients and sends back responses back to clients
